...
@source "../../vendor/lara-zeus/filament-locationpickr-field/resources/views/**/*.blade.php";
@source "../../vendor/lara-zeus/filament-locationpickr-field/resources/views/themes/**/*.blade.php";
```
